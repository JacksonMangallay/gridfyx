...
<head>
    ...
    <title>Gridfyx v2.0.0-Beta</title>
    <link rel="shortcut icon" href="<?php url('/favicon.ico'); ?>" type="image/x-icon">
    <link rel="stylesheet" href="<?php url('/test.css'); ?>">

</head>
<body>
    <div class="wrapper">
        <h1>Gridfyx v2.0.0-Beta is now running. Happy coding!</h1>
        <p>If this is your first time using Gridfyx, check out the <a href="<?= url('/documentation'); ?>">manual guide here.</a></p>
